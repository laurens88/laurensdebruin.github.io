    ...
    <div>
      ...
      <div className={pagestyles.summaryContainer}>
        <div className={pagestyles.summary}>
          ...
          <p>Throughout my study program, work experience, and free time, I have always enjoyed working on larger projects. 
            Coding keeps me busy and helps me to constantly learn new things. 
            In my spare time, I love to explore new concepts and create projects that I can proudly share with others. 
            Whether it's developing a new app or experimenting with different programming languages, 
            I find great satisfaction in building something from scratch. 
            This passion for continuous learning and creation drives me to push my boundaries 
            and stay updated with the latest trends in technology.</p>
        </div>
      </div>
